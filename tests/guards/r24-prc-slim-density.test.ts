...
// practice family (Input + date-picker trigger + control-variants)
...
describe('R24-PR-C — Slim radius re-tune', () => {
    ...
    describe('Heights NOT touched (form-practice parity preserved)', () => {
        ...
        it('default size (md) still uses h-9 (parity with <Input>)', () => {
            ...
            // future roadmap can drop the whole practice family to
