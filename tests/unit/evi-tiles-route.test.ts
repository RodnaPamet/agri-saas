...
import { GET } from '@/app/api/t/[tenantSlug]/agro/locations/[locationId]/evi-tiles/route';
...
function call(qs: string) {
    ...
    const req = new NextRequest(`http://localhost/api/t/acme/agro/locations/loc-1/evi-tiles?${qs}`);
