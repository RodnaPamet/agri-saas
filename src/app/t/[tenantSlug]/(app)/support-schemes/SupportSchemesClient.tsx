...
export function SupportSchemesClient(props: Props) {
...
function SupportSchemesInner({ initialSchemes }: Props) {
    ...
    const query = useTenantSWR<SupportSchemeRow[]>(CACHE_KEYS.supportSchemes.list(), {
    ...
    return (
        <EntityListPage<SupportSchemeRow>
            ...
            table={{
                ...
                'data-testid': 'support-schemes-table',
            }}
        />
    );
}
