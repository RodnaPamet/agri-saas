              ...
              <Command loop shouldFilter={false}>
                <div className="flex items-center overflow-hidden rounded-t-lg border-b border-border-subtle">
                  <Command.Input
                    ...
                    className="grow border-0 py-3 pl-4 pr-2 outline-none placeholder:text-content-subtle focus:ring-0 text-base sm:text-sm bg-transparent text-content-emphasis"
                    autoCapitalize="none"
                  />
                </div>
                <div className="scrollbar-hide max-h-[50svh] w-screen overflow-y-scroll sm:w-auto">
